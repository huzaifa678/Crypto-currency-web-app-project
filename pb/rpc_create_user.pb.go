...
type CreateUserRequest struct {
	...
	Role          UserRole               `protobuf:"varint,4,opt,name=role,proto3,enum=pb.UserRole" json:"role,omitempty"`
...
const file_rpc_create_user_proto_rawDesc = "" +
	...
	"\x04role\x18\x04 \x01(\x0e2\f.pb.UserRoleR\x04role\"-\n" +
	"\x12CreateUserResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userIdB:Z8github.com/huzaifa678/Crypto-currency-web-app-project/pbb\x06proto3"
...
var file_rpc_create_user_proto_depIdxs = []int32{
	2, // 0: pb.CreateUserRequest.role:type_name -> pb.UserRole
