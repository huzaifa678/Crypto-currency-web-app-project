...
const file_rpc_verify_email_proto_rawDesc = "" +
	"\n" +
	"\x16rpc_verify_email.proto\x12\x02pb\"l\n" +
	"\x12VerifyEmailRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x19\n" +
	"\bemail_id\x18\x02 \x01(\x03R\aemailId\x12\x1f\n" +
	"\vsecret_code\x18\x03 \x01(\tR\n" +
	"secretCode\"6\n" +
	"\x13VerifyEmailResponse\x12\x1f\n" +
	"\vis_verified\x18\x01 \x01(\bR\n" +
	"isVerifiedB:Z8github.com/huzaifa678/Crypto-currency-web-app-project/pbb\x06proto3"
